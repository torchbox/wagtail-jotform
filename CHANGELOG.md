...
- Drop support for Wagtail 6.3 (now outside the previous-LTS → latest-LTS range)
...
- Drop support for Wagtail 7.1 (no longer in upstream active or security support)
